...
$applications = $query4->select('*')
    ...
    ->execute()
    ->getResult();
$id = $applications[0]->tradesperson_id;
...
<section class="section is-medium has-background-light-gray mt-6 min-height-100vh">
    <div class=" container">
                ...
                <div class="columns is-multiline is-mobile">
                    ...
                    <div class="column is-7-tablet ">
                        ...
                        <div class="pw-icon">
                            ...
                            <p class="mb-2">
                                <?= $applications[0]->profiles->address ?>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="column is-5-tablet is-full-mobile  ">
            ...
            <span class="text-job">
                <?= $parser->parse($applications[0]->profiles->description ? $applications[0]->profiles->description : '-- No Description --'); ?>
            </span>
            <div class="mt-3">
