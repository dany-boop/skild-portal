		...
		<div class="columns is-multiline is-mobile">
			...
			<div class="column is-full-mobile pl-5-tablet is-6-tablet">
				<form action="process/projects.php" method="post" id="form-submit" name="form-submit"
					...
					<input type="hidden" name="contractor_id" value=<?= $_SESSION['id'] ?>>
					<div class="card">
						<div class="card-content">
							...
							<div class="columns is-multiline is-mobile">
								...
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<?= input("Building area m2", "building_area", "Please fill this field", null) ?>
								</div>
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<?= input("Land area m2", "land_area", "Please fill this field", null) ?>
								</div>
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<?= input("Number of floors", "floor", "Please fill this field", null) ?>
								</div>
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<?= input("Estimated Budget", "estimated_budget", "Please fill this field", null) ?>
								</div>
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<?= input("Estimated Days", "estimated_day", "Please fill this field", null) ?>
								</div>
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<?= input("Number Of Trades", "number_trades", "Please fill this field", null) ?>
								</div>
								<div class="column is-full-mobile is-6-tablet is-relative ">
								...
								<div class="column is-full-mobile is-12-tablet is-relative ">
									<?= textarea("Address", "address", "Please fill this field", null) ?>
								</div>
								<div class="column is-full-mobile is-12-tablet is-relative ">
									<?= input("District", "district", "Please fill this field", null) ?>
								</div>
								<div class="column is-full-mobile is-12-tablet is-relative ">
