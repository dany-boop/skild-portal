						...
						<div class="card-content">
							...
							<div class="columns is-multiline is-mobile">
								<div class="column is-full-mobile is-full-tablet is-relative ">
									<?= input("Name", "name", "Please fill this field", $experiences[0]->name) ?>
								</div>
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<?= input("Date Start", "date_start", "Please fill this field", $experiences[0]->date_start, 'date') ?>
								</div>
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<?= input("Date End", "date_end", "Please fill this field", $experiences[0]->date_end, 'date') ?>
								</div>
								<div class="column is-full-mobile is-12-tablet is-relative ">
									<?= textarea("Description", "description", "Please fill this field", $experiences[0]->description) ?>
								</div>
							</div>
						</div>
					</div>
