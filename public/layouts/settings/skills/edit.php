	...
	<div class="container">
		<div class="columns is-multiline is-mobile">
			...
			<div class="column is-full-mobile pl-5-tablet is-6-tablet">
				<form action="process/skill.php" method="post" id="form-submit" name="form-submit">
					...
					<div class="card">
						<div class="card-content">
							...
							<div class="columns is-multiline is-mobile">
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<?= input("Name", "name", "Please fill this field", $tradesskills[0]->name) ?>
								</div>
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<label class="label m-0 pl-0">Select Skill</label>
									<div class="select">
										<select name="skills">
											<option>Select Skill</option>
											<?php foreach ($skill as $value) { ?>
												<option value="<?= $value->id ?>" <?= $tradesskills[0]->skill_id == $value->id ? 'selected' : '' ?>>
													<?= $value->name ?>
												</option>
											<?php } ?>
										</select>
								...
								<div class="column is-full-mobile is-12-tablet is-relative ">
									<?= textarea("Description", "description", "Please fill this field", $tradesskills[0]->description) ?>
								</div>
							</div>
						</div>
					</div>
