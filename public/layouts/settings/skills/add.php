...
// $skills = $profile[0]->tradesskills ? $profile[0]->tradesskills->name : '-';
		...
		<div class="columns is-multiline is-mobile">
			...
			<div class="column is-full-mobile pl-5-tablet is-6-tablet">
				<form action="process/skill.php" method="post" id="form-submit" name="form-submit">
					...
					<input type="hidden" name="tradesperson" value=<?= $_SESSION['id'] ?>>
					<div class="card">
						<div class="card-content">
							...
							<div class="columns is-multiline is-mobile">
								<div class="column is-full-mobile is-6-tablet is-relative ">
									<?= input("Name", "name", "Please fill this field with Related Content", null) ?>
								</div>
								<div class="column is-full-mobile is-6-tablet is-relative ">
