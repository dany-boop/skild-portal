				...
				<div class="card card-payment">
					<div class="card-content">
						<div class="columns is-multiline is-mobile add-border-bottom is-vcentered">
							...
							<div class="column is-full-mobile is-6-tablet is-relative ">
								<a href="skill/add"><button class="btn-blue button float-right">Add</button></a>
							</div>
						</div>
							...
							<div class="column is-full-mobile is-12-tablet is-relative ">
								...
								<table id="myTable" class="display table table-small">
									<thead>
										<tr>
											<th width="50">#</th>
											<th class="has-text-centered">Skills Name</th>
									...
									<tbody>
										...
										foreach ($tradesskills as $value) { ?>
											<tr>
												...
												<td class="has-text-centered">
													<?= icon_action("skill/edit/" . $value->id, $value->id, true, true,) ?>
												</td>
											</tr>
										<?php $x++;
										} ?>
